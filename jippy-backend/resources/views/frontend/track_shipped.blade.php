...
<div class="order-list">
    ...
    @empty
        <div style="text-align: center; padding: 50px;">
            <h3>Tidak ada paket yang sedang dikirim.</h3>
            <br>
            <a href="{{ route('track.order', ['status' => 'all']) }}" style="color: #ff69b4; text-decoration: underline;">Lihat Semua Pesanan</a>
        </div>
    @endforelse
</div>
